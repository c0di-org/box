...
private fun BoxRoot(boxViewModel: BoxViewModel = viewModel(factory = BoxContainer.factory)) {
    ...
    BoxTheme {
        BoxApp(
            ...
            onSetAgentModel = boxViewModel::setAgentModel,
            ...
            onShowPasteKey = boxViewModel::showCredentialSheet,
            onSubmitCredential = boxViewModel::submitCredential,
            onDismissPasteKey = boxViewModel::dismissCredentialSheet,
